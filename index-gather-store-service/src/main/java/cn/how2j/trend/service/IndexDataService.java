...
public class IndexDataService {
    ...
    @HystrixCommand(fallbackMethod = "third_part_non_connected")
    public List<IndexData> fresh(String code){
        List<IndexData> indexList  = fetch_indexes_from_third_part(code);
        indexDatas.put(code,indexList);
    ...
    public List<IndexData> third_part_non_connected(String code){
